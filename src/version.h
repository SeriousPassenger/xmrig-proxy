...
#define APP_ID        "xmrig-proxy-marker"
#define APP_NAME      "xmrig-proxy-marker"
#define APP_DESC      "XMRig Stratum proxy with custom markers"
#define APP_VERSION   "6.26.6-marker6-xmrtokyo"
